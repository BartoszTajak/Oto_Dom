...
if __name__ == "__main__":
    ...
    parser_models.add_argument('-db', default='mongo', help='show all db in mongo',metavar='')
    ...
    parser_web.add_argument('-w1', '--rodzaj', type=str, metavar='', help='apartamentowiec, blok', required=True)
    ...
    parser_web.add_argument('-w5', '--max_price', type=int, metavar='', default=10000000)
